...
class BlogTestBase(TestCase):
    ...
    def setUp(self):
        ...
        self.publication1 = Publication.objects.create(
            title="Новое пиво", text="Текст о новом пиве", rubric="Новости", publication_type="full", is_published=True
        )
        ...
        self.photo1 = Photo.objects.create(
            ...
            image=SimpleUploadedFile(name="test_photo1.jpg", content=b"", content_type="image/jpeg"),
            caption="Фото 1",
        )

        self.photo2 = Photo.objects.create(
            publication=self.publication2,
            image=SimpleUploadedFile(name="test_photo2.jpg", content=b"", content_type="image/jpeg"),
            caption="Фото 2",
        )
...
class PublicationCreateViewTests(BlogTestBase):
    ...
    def test_publication_create_success(self):
        ...
        response = self.client.post(reverse("blog:publication_create"), data=form_data)
